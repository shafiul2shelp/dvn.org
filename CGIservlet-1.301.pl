...
#               for security reasons (suggested by Hayek).
# 22 Jul 2003 - Added error checking to doarg (suggested by Hayek)
# 22 Jul 2003 - Removed SERVER_PORT from HTTP_HOST (Bug found by Hayek)
