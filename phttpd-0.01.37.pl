#!/usr/bin/perl
# karakurt - pure perl httpd v0.01.37 (c) mahatma, GPLs

=head1 NAME

phttpd-0.01.37.pl - karakurt, small pure Perl httpd ([x]inetd or standalone).
...
karakurt, pure Perl httpd v0.01.37           (c) Dzianis Kahanovich, GPLs
