#!/usr/bin/perl
# karakurt - pure perl httpd v0.01.43 (c) mahatma, GPLs

=head1 NAME

phttpd-0.01.43.pl - karakurt, small pure Perl httpd ([x]inetd or standalone).
...
karakurt, pure Perl httpd v0.01.43           (c) Dzianis Kahanovich, GPLs
